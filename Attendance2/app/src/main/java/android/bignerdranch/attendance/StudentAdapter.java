...
public class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.StudentViewHolder> {
    ...
    private int getColor(int position) {
        ...
        if(status.equals("E"))
            return Color.parseColor("#"+Integer.toHexString(ContextCompat.getColor(context,R.color.exist)));
        else if (status.equals("A"))
            return Color.parseColor("#"+Integer.toHexString(ContextCompat.getColor(context,R.color.absence)));
